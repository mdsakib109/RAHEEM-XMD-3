...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "RAHEEM-XMD-2>>>Ck4gCISY#PHh9UvCPhlTKzZLIoyKNkEL--kopeFQnPfWiWmsQY4M",
// add your Session Id 
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/r85tqj.mp4",
...
OWNER_NAME: process.env.OWNER_NAME || "YoUr sakin",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴇᴠ RAHEEM-CM*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/r85tqj.mp4",
